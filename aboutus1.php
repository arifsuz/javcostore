...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			<h4 style="text-indent:60px;">Untuk menyediakan alas kaki berkualitas tinggi yang sesuai dengan gaya atlet dan menjadi salah satu pakaian olahraga terkemuka di negeri ini.</h4>
			<br />
			<legend>
				<h3>Visi</h3>
			</legend>
			<h4 style="text-indent:60px;">Alphaware, perusahaan yang menginspirasi, memotivasi, dan memberikan tekad bagi para penggila olahraga.</h4>
			<br />
