...
(function () {
  ...
  E = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/4.0.4/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/4.0.4/gfx/vml-radial-gradient.png",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 0,
  ...
  S.prototype = {
    ...
    css: function (a) {
      ...
      if (e) {
        e = this.textWidth =
          a && a.width && d.nodeName.toLowerCase() === "text" && y(a.width);
        b && (a = r(b, c));
        this.styles = a;
        ...
        ? ((d.ontouchstart = function (a) {
          ...
          (d.onclick = function (a) {
            (wa.indexOf("Android") === -1 ||
              Da.now() - (c.touchEventFired || 0) > 1100) &&
              b.call(d, a);
          }))
        : (d["on" + a] = b);
      return this;
    ...
    show: function (a) {
      a && this.element.namespaceURI === xa
  ...
  S.prototype["stroke-widthSetter"] = S.prototype.strokeSetter = function (
    a,
    b,
    c
  ) {
    ...
    if (this.stroke && this["stroke-width"])
      (this.strokeWidth = this["stroke-width"]),
        S.prototype.fillSetter.call(this, this.stroke, "stroke", c),
  ...
  ta.prototype = {
    ...
    init: function (a, b, c, d, e) {
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(x.createTextNode("Created with Highcharts 4.0.4"));
            ...
            q(g, function (e) {
              if (e !== "" || g.length === 1) {
                ...
                if (e !== " ") {
                  ...
                  !n &&
                    f &&
                    (!ba && d && B(o, { display: "block" }), F(o, "dy", Y(o)));
                  if (l)
                    for (
                      ...
                      delete a.bBox,
                        ...
                        !ba &&
                          c.forExport &&
                          (D = c.measureSpanWidth(o.firstChild.data, a.styles)),
                        (q = D > l),
                        !q || e.length === 1
                          ? ((e = t),
                            (t = []),
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        a = o.element.style;
        D =
          (t === void 0 || xb === void 0 || m.styles.textAlign) &&
          o.textStr &&
          o.getBBox();
        ...
        if (y) {
          if (!p)
            (a = v(-J * C)),
              ...
              (m.box = p =
                d
                  ? n.symbol(d, a, b, m.width, m.height, z)
                  : n.rect(a, b, m.width, m.height, 0, z[Qb])),
              p.attr("fill", P).add(m);
        ...
        if (b.tagName === "SPAN") {
          ...
          if (n !== this.cTT) {
            ...
            if (i > l && /[ \-]/.test(b.textContent || b.innerText))
              B(b, { width: l + "px", display: "block", whiteSpace: "normal" }),
                (i = l);
  ...
  Ta.prototype = {
    addLabel: function () {
      ...
      a.isDatetimeAxis &&
        m &&
        (n = b.dateTimeLabelFormats[m.higherRanks[g] || m.unitName]);
      this.isFirst = k;
      this.isLast = l;
    ...
    handleOverflow: function (a, b) {
      ...
      if (m) {
        ...
        (e && !h) || (f && h)
          ? g + k < l && ((g = l - k), m && g + j > d && (c = !1))
          : g + j > n && ((g = n - j), m && g + k < d && (c = !1));
        b.x = g;
      }
      return c;
    },
    ...
    render: function (a, b, c) {
      ...
      if (n && J)
        t === "inside" && (J = -J),
          d.opposite && (J = -J),
          (h = this.getMarkPath(x, w, J, n * z, g, f)),
          m
            ? m.animate({ d: h, opacity: c })
            : (this.mark = f
                .path(h)
                .attr({ stroke: C, "stroke-width": n, opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(x))
  ...
  na.prototype = {
    ...
    init: function (a, b) {
      ...
      this.tickmarkOffset =
        this.categories &&
        d.tickmarkPlacement === "between" &&
        p(d.tickInterval, 1) === 1
          ? 0.5
          : 0;
      this.ticks = {};
      this.labelEdge = [];
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              (a.dataMin = L(p(a.dataMin, d[0]), Oa(d))),
    ...
    setTickPositions: function (a) {
      ...
      j
        ? ((b.linkedParent = c[b.coll][d.linkedTo]),
          ...
          d.type !== b.linkedParent.options.type && ha(11, 1))
        : ((b.min = p(b.userMin, d.min, b.dataMin)),
          (b.max = p(b.userMax, d.max, b.dataMax)));
      if (g)
        !a && L(b.min, p(b.dataMin, b.min)) <= 0 && ha(10, 1),
          (b.min = ea(za(b.min))),
          (b.max = ea(za(b.max)));
      if (b.range && s(b.max))
      ...
      b.min === b.max || b.min === void 0 || b.max === void 0
        ...
        : ((b.tickInterval = p(m, J ? 1 : ((b.max - b.min) * Y) / t(b.len, Y))),
          !s(m) &&
            b.len < Y &&
            !this.isRadial &&
            !this.isLog &&
      ...
      if (!a)
        !b.ordinalPositions &&
          (b.max - b.min) / b.tickInterval > t(2 * b.len, 200) &&
          ha(19, !0),
          (a = h
            ? b.getTimeTicks(
        ...
        if (a.horiz && !a.staggerLines && w && !Y.rotation) {
          for (j = a.reversed ? [].concat(e).reverse() : e; v < w; ) {
            ...
            for (r = 0; r < j.length; r++)
              (A = j[r]),
                (z = (z = f[A].label && f[A].label.getBBox()) ? z.width : 0),
                (R = r % v),
                z &&
                  ((A = a.translate(A)),
                  x[R] !== u && A < x[R] && (y = !0),
          ...
          i.length &&
            ...
            q(j, function (b, c) {
              ...
              if (!h || (b >= a.min && b <= a.max))
                l[b] || (l[b] = new Ta(a, b)),
                  C && l[b].isNew && l[b].render(c, !0, 0.1),
                  l[b].render(c);
            }),
            D &&
              a.min === 0 &&
              (l[-1] || (l[-1] = new Ta(a, -1, null, !0)), l[-1].render(-1))),
          p &&
            q(i, function (b, c) {
              if (c % 2 === 0 && b < a.max)
                m[b] || (m[b] = new K.PlotLineOrBand(a)),
                  (v = b + D),
                  (A = i[c + 1] !== u ? i[c + 1] + D : a.max),
                  (m[b].options = {
                    from: g ? ka(v) : v,
                    to: g ? ka(A) : A,
                    color: p,
      ...
      if (J)
        (b = a.getLinePath(J)),
          a.axisLine
            ...
            : (a.axisLine = e
                .path(b)
                .attr({ stroke: f.lineColor, "stroke-width": J, zIndex: 7 })
                .add(a.axisGroup)),
    ...
    if (s(b)) {
      ...
      for (
        var d = i.getTime(),
          l = i[fb](),
          n = i[Xa](),
          m = (A.day + (g ? Sa : i.getTimezoneOffset() * 6e4)) % A.day;
        d < c;
  ...
  Wa.prototype = {
    ...
    drag: function (a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          f &&
          ((d -= n),
          this.selectionMarker.attr({ width: Q(d), x: (d > 0 ? 0 : d) + n }));
        this.selectionMarker &&
          g &&
          ((d = e - m),
          this.selectionMarker.attr({ height: Q(d), y: (d > 0 ? 0 : d) + m }));
    ...
    drop: function (a) {
        ...
        if (this.hasDragged || c)
          q(b.axes, function (b) {
            if (b.zoomEnabled) {
              ...
              !isNaN(m) &&
                !isNaN(c) &&
                (d[b.coll].push({ axis: b, min: L(m, c), max: t(m, c) }),
                (j = !0));
            }
          }),
            j &&
      ...
      if (b)
        B(b.container, { cursor: b._cursor }),
  ...
  r(K.Pointer.prototype, {
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
      ...
      b < C.min
        ? ((b = C.min), (x = !0))
        : b + o > C.max && ((b = C.max - o), (x = !0));
      x
        ? ((v -= 0.8 * (v - g[j][0])), t || (w -= 0.8 * (w - g[j][1])), c())
        : (g[j] = [v, w]);
      r || ((f[j] = p - m), (f[n] = o));
      f = r ? 1 / q : q;
      e[n] = o;
  ...
  if (G.PointerEvent || G.MSPointerEvent) {
    ...
    r(Wa.prototype, {
      ...
      batchMSEvents: function (a) {
        a(
          ...
          zb ? "pointerdown" : "MSPointerDown",
          this.onContainerPointerDown
        );
        a(
          this.chart.container,
          zb ? "pointermove" : "MSPointerMove",
    ...
    Na(Wa.prototype, "init", function (a, b, c) {
      ...
      (this.hasZoom || this.followTouchMove) &&
        B(b.container, { "-ms-touch-action": P, "touch-action": P });
    });
  ...
  lb.prototype = {
    ...
    renderItem: function (a) {
      ...
      e
        ? (this.itemX += f)
        : ((this.itemY += o + g + m), (this.lastLineHeight = g));
      this.offsetWidth =
        n || t((e ? this.itemX - q - k : f) + j, this.offsetWidth);
    },
  ...
  Ya.prototype = {
    ...
    layOutTitles: function (a) {
      ...
      d &&
        ...
        !e.floating && !e.verticalAlign && (b = La(b + d.getBBox().height)));
    ...
    drawChartBox: function () {
      ...
      if (n)
        g
          ? g.animate(
              g.crisp({ x: o, y: p, width: q, height: r, strokeWidth: -n })
            )
          : (this.plotBorder = b
              .rect(o, p, q, r, 0, -n)
              .attr({
    ...
    isReadyToRender: function () {
      var a = this;
      return (!ba && G == G.top && x.readyState !== "complete") ||
        (ga && !G.canvg)
        ? (ga
            ? Mb.push(function () {
                a.firstRender();
    ...
    processData: function (a) {
      ...
      if (l && this.sorted && (!i || d > i || this.forceCrop))
        if (b[d - 1] < m || b[0] > n) (b = []), (c = []);
          ...
          (e = this.cropData(this.xData, this.yData, m, n)),
            (b = e.xData),
            (c = e.yData),
            (e = e.start),
            (f = !0),
    ...
    translate: function () {
      ...
      for (
        ...
        var l = f[a],
          ...
          o = l.low,
          q =
            b && e.stacks[(this.negStacks && m < k ? "-" : "") + this.stackKey];
        ...
        l.plotY =
          typeof m === "number" && m !== Infinity
            ? e.translate(m, 0, 1, 0, 1)
            : u;
    ...
    drawPoints: function () {
      var a,
        ...
        s = p(
          l.enabled,
          !this.requireSorting ||
            this.activePointCount < (0.5 * this.xAxis.len) / l.radius
        );
        ...
        for (f = b.length; f--; )
          if (
            ...
            if (
              ...
              (h = a.r),
              (i = p(m.symbol, this.symbol)),
              (j = i.indexOf("url") === 0),
              k)
            )
              k[q ? "show" : "hide"](!0).animate(
                r(
                  { x: d - h, y: e - h },
  ...
  O.prototype.setStackedPoints = function () {
    if (
      ...
      for (q = 0; q < d; q++) {
        ...
        if (!l[o][r])
          n[o] && n[o][r]
            ? ((l[o][r] = n[o][r]), (l[o][r].total = null))
            : (l[o][r] = new Gb(k, k.options.stackLabels, m, r, g));
        o = l[o][r];
        o.points[p] = [o.cum || 0];
        e === "percent"
          ? ((m = m ? h : i),
            j && l[m] && l[m][r]
              ? ((m = l[m][r]),
                (o.total = m.total = t(m.total, o.total) + Q(s) || 0))
  ...
  ia = ma(O, {
    ...
    getPointSpline: function (a, b, c) {
      ...
      if (f && g) {
        ...
        i > a && i > e
          ? ((i = t(a, e)), (k = 2 * e - i))
          : i < a && i < e && ((i = L(a, e)), (k = 2 * e - i));
        k > g && k > e
          ? ((k = t(g, e)), (i = 2 * e - k))
          : k < g && k < e && ((k = L(g, e)), (i = 2 * e - k));
        b.rightContX = j;
        b.rightContY = k;
      }
      c
  ...
  ia = ma(O, {
    ...
    animate: function (a) {
      ...
      if (ba)
        a
          ? ((e.scaleY = 0.001),
            (a = L(b.pos + b.len, t(b.pos, b.toPixels(c.threshold)))),
        ...
        q(e, function (b) {
          ...
          if (h && !e) b.dataLabel = h.destroy();
            ...
            if (h)
              ...
              h = b.dataLabel = a.chart.renderer[e ? "text" : "label"](
                i,
                0,
                -999,
                null,
  ...
  if (H.pie)
    (H.pie.prototype.drawDataLabels = function () {
          ...
          if (K) {
            ...
            for (z = b = 0; !b && F[z]; )
              (b =
                F[z] &&
                F[z].dataLabel &&
                (F[z].dataLabel.getBBox().height || 21)),
                z++;
            if (n > 0) {
            ...
            for (z = 0; z < K; z++) {
              ...
              if (n > 0) {
                if (
                  ...
                  (E = w.i),
                  (B = w.y),
                  (c > B && G[E + 1] !== null) || (c < B && G[E - 1] !== null))
                )
                  B = L(t(0, c), d.plotHeight);
              } else B = c;
              y = e.justify
                ? m[0] + (H ? -1 : 1) * (o + n)
                : a.getX(B === r - o - n || B === r + o + n ? c : B, H);
              ...
              if (this.options.size === null)
                (w = u.width),
                  y - w < f
                    ? (R[3] = t(v(w - y + f), R[3]))
                    : y + w > h - f && (R[1] = t(v(y + w - h + f), R[1])),
                  B - b / 2 < 0
                    ? (R[0] = t(v(-B + b / 2), R[0]))
                    : B + b / 2 > i && (R[2] = t(v(B + b / 2 - i), R[2]));
            }
          }
        }
      ...
      (H.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        d[1] !== null
          ? (e = t(L(e, b[2] - t(a[0], a[2])), c))
          : ((e = t(L(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
        e < b[2]
          ? ((b[2] = e),
            this.translate(b),
            q(this.points, function (a) {
